...
window.addEventListener('DOMContentLoaded', function () {
  function onSlider(slidesWrapper, slidesClass, nextBtnClass, prevBtnClass) {
    var slider = document.querySelector(slidesWrapper),
  ...
  var prevModalDialog = document.querySelector('.modal__wrapper');
  ...
  document.querySelector('.form__tel').addEventListener('input', function (e) {
    var phone = document.querySelector('.form__tel');
  ...
  function showThanksModal(message) {
    ...
    modal.addEventListener('click', function (e) {
      if (e.target === document.querySelector('.modal__close') || e.target === document.querySelector('.modal__closeBtn') || e.target === modal) {
        clearTimeout(timout);
        closeModal();
      }
    });
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              console.log(object);
              postData('http://localhost:3000/requests', JSON.stringify(object)).then(function (data) {
                console.log(data);
